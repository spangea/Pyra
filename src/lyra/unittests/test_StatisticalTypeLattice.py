...
class TestStatisticalTypeLattice(unittest.TestCase):
    ...
    def test_less_equal_top(self):
        self.assertTrue(self.top_el()._less_equal(self.top_el()))
        self.assertTrue(self.data_frame()._less_equal(self.top_el()))
        self.assertTrue(self.string()._less_equal(self.top_el()))
        self.assertTrue(self.numeric()._less_equal(self.top_el()))
        self.assertTrue(self.boolean()._less_equal(self.top_el()))
        self.assertTrue(self.bottom_el()._less_equal(self.top_el()))
        self.assertTrue(self.tuple()._less_equal(self.top_el()))
        self.assertTrue(self.dict()._less_equal(self.top_el()))

        self.assertTrue(self.series()._less_equal(self.top_el()))
        self.assertFalse(self.top_el()._less_equal(self.series()))

        for num_series_status in StatisticalTypeLattice._numeric_series_types():
            self.assertTrue(StatisticalTypeLattice(num_series_status)._less_equal(self.top_el()))
            self.assertFalse(self.top_el()._less_equal(StatisticalTypeLattice(num_series_status)))

        for string_series_status in StatisticalTypeLattice._string_series_types():
            self.assertTrue(StatisticalTypeLattice(string_series_status)._less_equal(self.top_el()))
            self.assertFalse(self.top_el()._less_equal(StatisticalTypeLattice(string_series_status)))

        for array_status in StatisticalTypeLattice._array_types():
            self.assertTrue(StatisticalTypeLattice(array_status)._less_equal(self.top_el()))
            self.assertFalse(self.top_el()._less_equal(StatisticalTypeLattice(array_status)))

        for list_status in StatisticalTypeLattice._list_types():
            self.assertTrue(StatisticalTypeLattice(list_status)._less_equal(self.top_el()))
            self.assertFalse(self.top_el()._less_equal(StatisticalTypeLattice(list_status)))

    def test_less_equal_same(self):
        self.assertTrue(self.top_el()._less_equal(self.top_el()))
        self.assertTrue(self.data_frame()._less_equal(self.data_frame()))
        self.assertTrue(self.string()._less_equal(self.string()))
        self.assertTrue(self.numeric()._less_equal(self.numeric()))
        self.assertTrue(self.boolean()._less_equal(self.boolean()))
        self.assertTrue(self.bottom_el()._less_equal(self.bottom_el()))

        self.assertTrue(self.series()._less_equal(self.series()))
        self.assertTrue(self.tuple()._less_equal(self.tuple()))
        self.assertTrue(self.dict()._less_equal(self.dict()))

        for num_series_status in StatisticalTypeLattice._numeric_series_types():
            self.assertTrue(StatisticalTypeLattice(num_series_status)._less_equal(StatisticalTypeLattice(num_series_status)))

        for string_series_status in StatisticalTypeLattice._string_series_types():
            self.assertTrue(StatisticalTypeLattice(string_series_status)._less_equal(StatisticalTypeLattice(string_series_status)))

        for array_status in StatisticalTypeLattice._array_types():
            self.assertTrue(StatisticalTypeLattice(array_status)._less_equal(StatisticalTypeLattice(array_status)))

        for list_status in StatisticalTypeLattice._list_types():
            self.assertTrue(StatisticalTypeLattice(list_status)._less_equal(StatisticalTypeLattice(list_status)))

    def test_less_equal_bottom(self):
        self.assertTrue(self.bottom_el()._less_equal(self.bottom_el()))
        self.assertTrue(self.bottom_el()._less_equal(self.data_frame()))
        self.assertTrue(self.bottom_el()._less_equal(self.string()))
        self.assertTrue(self.bottom_el()._less_equal(self.numeric()))
        self.assertTrue(self.bottom_el()._less_equal(self.boolean()))
        self.assertTrue(self.bottom_el()._less_equal(self.top_el()))
        self.assertTrue(self.bottom_el()._less_equal(self.dict()))
        self.assertTrue(self.bottom_el()._less_equal(self.tuple()))

        self.assertTrue(self.bottom_el()._less_equal(self.series()))
        self.assertFalse(self.series()._less_equal(self.bottom_el()))

        for num_series_status in StatisticalTypeLattice._numeric_series_types():
            self.assertFalse(StatisticalTypeLattice(num_series_status)._less_equal(self.bottom_el()))
            self.assertTrue(self.bottom_el()._less_equal(StatisticalTypeLattice(num_series_status)))

        for string_series_status in StatisticalTypeLattice._string_series_types():
            self.assertFalse(StatisticalTypeLattice(string_series_status)._less_equal(self.bottom_el()))
            self.assertTrue(self.bottom_el()._less_equal(StatisticalTypeLattice(string_series_status)))

        for array_status in StatisticalTypeLattice._string_series_types():
            self.assertFalse(StatisticalTypeLattice(array_status)._less_equal(self.bottom_el()))
            self.assertTrue(self.bottom_el()._less_equal(StatisticalTypeLattice(array_status)))

        for list_status in StatisticalTypeLattice._string_series_types():
            self.assertFalse(StatisticalTypeLattice(list_status)._less_equal(self.bottom_el()))
            self.assertTrue(self.bottom_el()._less_equal(StatisticalTypeLattice(list_status)))
