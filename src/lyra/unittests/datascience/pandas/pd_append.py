...
s1 = df["points"].append(df["points"])
# STATE: data -> Dict; df -> DataFrame; df1 -> DataFrame; s1 -> Series; set1 -> Top
set1 = ["a"]
# STATE: data -> Dict; df -> DataFrame; df1 -> DataFrame; s1 -> Series; set1 -> StringList
set1.append("b")
# FINAL: data -> Dict; df -> DataFrame; df1 -> DataFrame; s1 -> Series; set1 -> StringList
