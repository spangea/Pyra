...
BASE_URL = "https://matplotlib.org/stable/api/index.html"
...
def crawl_matplotlib_warnings(base_url, urls_to_visit=None, visited_urls=None):
...
warnings_from_matplotlib_doc = crawl_matplotlib_warnings(
    BASE_URL, urls_to_visit=reachable_links
)

##### WARNING RESEARCH FINISHED #####
for url, warning_list in warnings_from_matplotlib_doc.items():
...
with open("matplotlib_warnings.json", "w") as f:
    json.dump(warnings_from_matplotlib_doc, f, indent=4)
