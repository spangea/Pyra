...
# Base URL for seaborn documentation
...
def crawl_seaborn_warnings(base_url, urls_to_visit=None, visited_urls=None):
    ...
    while urls_to_visit:
        ...
        # Otherwise, parse the current page to find links to other seaborn docs pages
        try:
        ...
        soup = BeautifulSoup(response.text, "html.parser")
        for a_tag in soup.find_all("a", href=True):
            # This should be the links to other seaborn documentation pages
...
warnings_from_python_api = crawl_seaborn_warnings(
...
with open("seaborn_warnings.json", "w") as f:
